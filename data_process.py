...
class Data:
    ...
    def load_strfacts(self, data_dir='./data/JF17K/'):
        ...
        ent_list, rel_list = [], []
        max_ary = 0
        if dataset in ['WP20K','WP40K','WP20K-4','WP40K-5','JF17K', 'FB-AUTO', 'WikiPeople', 'M-FB15K', 'WikiPeople-3', 'WikiPeople-4', 'WikiPeople-5', 'JF17K-3', 'JF17K-4', 'JF17K-5', 'WP-3F', 'WP-4F', 'JF-3F', 'JF-4F']:
                ...
                for miss_ent_domain in range(1, ary + 1):
                    ...
                    for i, x0 in enumerate(x[1:]):
                        if i + 1 != miss_ent_domain:
                            ...
                            # 使用 -1 作为占位符，而不是 miss_ent_domain * 111111
                            key_str.append(-1)
