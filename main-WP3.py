...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="WikiPeople-3", nargs="?", help="WP20K/WP40K/FB-AUTO/JF17K/WikiPeople/M-FB15K.")
    parser.add_argument("--num_iterations", type=int, default=500, nargs="?", help="Number of iterations.")
    
    parser.add_argument("--batch_size", type=int, default=900 , nargs="?", help="Batch size.")
    parser.add_argument("--lr", type=float, default=0.00027, nargs="?", help="Learning rate.")
    ...
    parser.add_argument("--VarRAC_Size", type=int, default=2, nargs="?", help="The size of KC.")
    parser.add_argument("--PosRAC_Size", type=int, default=20, nargs="?", help="The size of PC.")
