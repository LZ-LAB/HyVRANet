...
class Experiment:
    def __init__(self, num_iterations, batch_size, lr, dr, input_drop, hidden_drop, feature_drop,
                 VarRAC_Size, PosRAC_Size,emb_dim, emb_dim1, max_ary):          
        ...
        self.emb_dim, self.emb_dim1 = emb_dim, emb_dim1
    ...
    def train_and_eval(self):
        ...
        model = HyVRANet(len(d.ent2id), len(d.rel2id), self.input_drop, self.hidden_drop, self.feature_drop,
                          ...
                          self.emb_dim, self.emb_dim1, self.max_ary, self.device)
        model.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="WP20K", nargs="?", help="WP20K/WP40K/FB-AUTO/JF17K/WikiPeople/M-FB15K.")
    ...
    parser.add_argument("--emb_dim1", type=int, default=10, nargs="?")
    ...
    param['emb_dim'], param['emb_dim1'] = args.emb_dim, args.emb_dim1
    ...
    Exp = Experiment(num_iterations=param['num_iterations'], batch_size=param['batch_size'], lr=param['lr'], dr=param['dr'],
                     ...
                     emb_dim=param['emb_dim'], emb_dim1=param['emb_dim1'], max_ary=d.max_ary)
    Exp.train_and_eval()
